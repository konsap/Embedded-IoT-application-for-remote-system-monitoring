...
extern void http_server_thread_create(void);
extern void temperature_thread_create(void);
extern void light_thread_create(void);
extern void usb_thread_create(void);
extern void Humidity_thread_create(void);
...
void tx_application_define(void *first_unused_memory)
{
    ...
    http_server_thread_create ();
    temperature_thread_create ();
    light_thread_create ();
    usb_thread_create ();
    Humidity_thread_create ();
    led_thread_create ();
